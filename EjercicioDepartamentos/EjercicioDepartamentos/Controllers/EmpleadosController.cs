...
namespace EjercicioDepartamentos.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        {
            List<Empleado> empleados = await _context.Empleados.Include(x => x.Departamento).ToListAsync();
            ViewData["departamentos"] =await _context.Departamentos.Select(x=>x.Nombre).ToListAsync();
